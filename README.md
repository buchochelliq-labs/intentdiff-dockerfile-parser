# intentumdiff-dockerfile-parser

[![CI](https://github.com/buchochelliq-labs/intentumdiff-dockerfile-parser/actions/workflows/ci.yml/badge.svg)](https://github.com/buchochelliq-labs/intentumdiff-dockerfile-parser/actions/workflows/ci.yml)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](LICENSE)
[![Rust 1.95](https://img.shields.io/badge/rust-1.95-orange.svg)](https://www.rust-lang.org/)

The **dockerfile parser plugin** for IntentumDiff — a Wasm component (WASI p2, Component Model)
implementing the `intentumdiff:plugin` parser interface: it emits a deterministic
`SemanticNode` tree for dockerfile sources.
